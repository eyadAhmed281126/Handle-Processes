    ...
    case WM_COMMAND:
        ...
        if (LOWORD(wp) == IDOK) {
            ...
            if (at < 0 || bt <= 0 || at > 1000 || bt > 1000) {
                MessageBox(h, L"Arrival Time must be 0 or more and less than or equal to 1000.\nBurst Time must be at least 1 and less than or equal to 1000.", L"Check Values", MB_OK | MB_ICONINFORMATION);
                return 0;
            }
